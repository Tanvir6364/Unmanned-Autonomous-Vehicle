            ...
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    if sensor_data and int(sensor_data) < 30:
                        while int(sensor_data)<30:
                            print("Stop, obstacle in front")
                            self.rc_car.stop()
                        sensor_data = None

                    elif 0 < self.d_stop_sign < 50 and stop_sign_active:
                        ...
                        if stop_sign_active is False:
                            ...
                            if self.drive_time_after_stop > 7:
                                stop_sign_active = True
...
if __name__ == '__main__':
    h, p1, p2 = "192.168.43.195", 8000, 8002
